<template>
  <div class="table-toolbar">
    ...
    <div class="flex items-center table-toolbar-right">
      ...
      <!-- <n-tooltip trigger="hover">
        <template #trigger>
          <div class="table-toolbar-right-icon" @click="reload" style="margin-top: 8px">
            <n-icon size="18">
              <ReloadOutlined />
            </n-icon>
          </div>
      ...
      <!-- <n-tooltip trigger="hover">
        <template #trigger>
          <div class="table-toolbar-right-icon">
            ...
            >
              <n-icon size="18" style="margin-top: 8px">
...
const densityOptions = [
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const pagination =route.name == 'accountPrice_index' ?false:computed(() => toRaw(unref(getPaginationInfo)));
      //获取分页信息
