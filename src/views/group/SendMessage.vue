...
let props = defineProps({ messageShowFlag: Number, groupList: Array<String> });
...
watch(
  ...
  async (newValue) => {
    await loadGroupOptions();
    formValue.value.groupList = newValue;
  }
);
